...
nc17 ={}
loadmat('config5.mat',nc17) # config2.mat generated by IZFORCECLASSIFICATION_randcontrol.m
...
plt.plot(nc17['time'].T,nc17['current_I'] - nc17['current_IPSC'],'r')
plt.xlabel('Time (ms)')
...
plt.plot(nc17['time'].T, nc17['current'],'g')
plt.plot(nc17['time'].T, nc17['zx'],'r')
plt.xlabel('Time (ms)')
plt.ylabel('Error')
