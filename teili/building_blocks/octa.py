...
#       self._groups['error_connection']._set_tags(tags_parameters.basic_tags_compression_con_octa, self._groups['error_connection'])
#       self._groups['prediction_connection']._set_tags(tags_parameters.basic_tags_prediction_con_octa, self._groups['prediction_connection'])
...
#Important check s_inh_exc exists in the generated connectons
    ...
    weight_decay_group =  [compressionWTA._groups['s_inp_exc']] + \
                ...
                [error_connection]
    add_decay_weight( weight_decay_group, weight_decay =octaParams['weight_decay'], 
    ...
    add_weight_pred_decay( pred_weight_decay_group, weight_decay=octaParams['weight_decay'],  
                        learning_rate=octaParams['learning_rate'] )    
