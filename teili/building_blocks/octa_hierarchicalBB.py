...
<<<<<<< HEAD:teili/building_blocks/octa_hierarchical_BB_level_1.py
=======
...
>>>>>>> a44121e... Written docs, commented code, working octa:teili/building_blocks/octa_hierarchicalBB.py
