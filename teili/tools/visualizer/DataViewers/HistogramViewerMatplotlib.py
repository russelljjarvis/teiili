...
class HistogramViewerMatplotlib(HistogramViewer):
    ...
    def __init__(self, MyPlotSettings, mainfig=None, subfig=None):
        ...
        Args:
            ...
            subfig (matplotlib subplot): matplotlib subplot of mainfig which will hold the histogram
        """
    ...
    def create_histogram(
            ...
            xlabel='bins',
            ylabel='count'):
        """ Function to create histogram for groups of event sets in self.subfig (spike times, neuron ids) with matplotlib
        Args:
